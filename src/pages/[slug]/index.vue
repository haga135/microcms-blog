...
/* ==========================================
   ▼ ここから下に、スマホ対応のコードを追記します
   ========================================== */
@media (max-width: 768px) {
  .main {
    width: 100%; /* スマホでは横幅を100%（画面いっぱい）にする */
    max-width: 100%;
    padding: 60px 20px; /* 上下の余白を少し縮め、左右に20pxの快適な余白を作る */
    box-sizing: border-box; /* 余白を横幅の中に含めてはみ出しを防ぐ */
  }

  .title {
    font-size: 2rem; /* スマホ用にタイトルの文字サイズを少し小さく調整 */
  }

  /* 記事本文内の文字が右端からはみ出さないようにする保険 */
  .md,
  .md:deep(*) {
    max-width: 100%;
    word-break: break-all; /* 長い英単語やURLがあっても自動で改行させる */
  }
}
</style>
